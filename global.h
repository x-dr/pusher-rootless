...
#define PUSHER_SERVICE_NOTIFYHUB @"NotifyHub"

#define BUILTIN_PUSHER_SERVICES @[ PUSHER_SERVICE_PUSHOVER, PUSHER_SERVICE_PUSHBULLET, PUSHER_SERVICE_IFTTT, PUSHER_SERVICE_PUSHER_RECEIVER, PUSHER_SERVICE_FEISHU, PUSHER_SERVICE_BARK, PUSHER_SERVICE_WECHAT, PUSHER_SERVICE_NOTIFYHUB ]

#import <Preferences/PSSpecifier.h>
#import <BulletinBoard/BBBulletin.h>
#if __has_include(<BulletinBoard/BBServer.h>)
